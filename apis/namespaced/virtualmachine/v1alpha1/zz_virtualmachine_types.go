...
type CustomizeInitParameters struct {
	...
	WindowsSysprepTextSecretRef *v1.LocalSecretKeySelector `json:"windowsSysprepTextSecretRef,omitempty" tf:"-"`
}
...
type LinuxOptionsInitParameters struct {
	...
	ScriptTextSecretRef *v1.LocalSecretKeySelector `json:"scriptTextSecretRef,omitempty" tf:"-"`
...
type VirtualMachineInitParameters struct {
	...
	NetworkInterface []VirtualMachineNetworkInterfaceInitParameters `json:"networkInterface,omitempty" tf:"network_interface,omitempty"`
...
type VirtualMachineNetworkInterfaceInitParameters struct {
...
type VirtualMachineNetworkInterfaceObservation struct {
...
type VirtualMachineNetworkInterfaceParameters struct {
...
type VirtualMachineObservation struct {
	...
	// A specification for a virtual NIC on this virtual machine.
	NetworkInterface []VirtualMachineNetworkInterfaceObservation `json:"networkInterface,omitempty" tf:"network_interface,omitempty"`
...
type VirtualMachineParameters struct {
	...
	// A specification for a virtual NIC on this virtual machine.
	// +kubebuilder:validation:Optional
	NetworkInterface []VirtualMachineNetworkInterfaceParameters `json:"networkInterface,omitempty" tf:"network_interface,omitempty"`
...
type WindowsOptionsInitParameters struct {
	...
	DomainAdminPasswordSecretRef *v1.LocalSecretKeySelector `json:"domainAdminPasswordSecretRef,omitempty" tf:"-"`
	...
	ProductKeySecretRef *v1.LocalSecretKeySelector `json:"productKeySecretRef,omitempty" tf:"-"`
...
type VirtualMachineSpec struct {
	...
	// autoscaler.
	InitProvider VirtualMachineInitParameters `json:"initProvider,omitempty"`
}
