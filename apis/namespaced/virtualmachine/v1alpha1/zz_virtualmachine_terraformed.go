...
func (tr *VirtualMachine) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"clone[*].customize[*].linux_options[*].script_text": "clone[*].customize[*].linuxOptions[*].scriptTextSecretRef", "clone[*].customize[*].windows_options[*].admin_password": "clone[*].customize[*].windowsOptions[*].adminPasswordSecretRef", "clone[*].customize[*].windows_options[*].domain_admin_password": "clone[*].customize[*].windowsOptions[*].domainAdminPasswordSecretRef", "clone[*].customize[*].windows_options[*].product_key": "clone[*].customize[*].windowsOptions[*].productKeySecretRef", "clone[*].customize[*].windows_sysprep_text": "clone[*].customize[*].windowsSysprepTextSecretRef"}
}

// GetObservation of this VirtualMachine
func (tr *VirtualMachine) GetObservation() (map[string]any, error) {
...
func (tr *VirtualMachine) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this VirtualMachine
func (tr *VirtualMachine) GetID() string {
...
func (tr *VirtualMachine) GetParameters() (map[string]any, error) {
...
func (tr *VirtualMachine) SetParameters(params map[string]any) error {
...
// GetInitParameters of this VirtualMachine
func (tr *VirtualMachine) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VirtualMachine
func (tr *VirtualMachine) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
