...
// GetInitParameters of this MachineSnapshot
func (tr *MachineSnapshot) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this MachineSnapshot
func (tr *MachineSnapshot) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this MachineSnapshot using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MachineSnapshot) LateInitialize(attrs []byte) (bool, error) {
	params := &MachineSnapshotParameters{}
